...
namespace ETModel {
  ...
  public partial class StateFrame_ClickMap : pb::IMessage {
    private static readonly pb::MessageParser<StateFrame_ClickMap> _parser = new pb::MessageParser<StateFrame_ClickMap>(() => (StateFrame_ClickMap)MessagePool.Instance.Fetch(typeof(StateFrame_ClickMap)));
    public static pb::MessageParser<StateFrame_ClickMap> Parser { get { return _parser; } }
